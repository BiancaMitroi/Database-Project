...
<style>
	...
	<table style><tr><td><a href = "site.html"><button><img src = "back.png" style = "width:40px; height: 40px;"></button></a></td>
        ...
        <td><h1>4 a) Să se găsească (id_d, descriere, fabricant, pret_c și pret_r) pentru piesele cu prețul de catalog mai mic cu 10% decât prețul real.</h1></td></tr></table>
        ...
        <?php
			...
			<tr>
			 ...
			 <th style = "border: 2px solid white; color: white;">pret_r</th>
			</tr>';
			for ($i=0; $i <$num_results; $i++)
			{
				...
				echo '<td style = "border: 2px solid white; color: white;">'.stripslashes($row['pret_r']).'</td>';
			}
			echo '</table></center>';
